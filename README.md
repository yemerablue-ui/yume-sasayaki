...
4. 環境音(雨・波・ノイズ系)を選ぶと入眠待ちの間に流れ、ささやきが始まる数秒前に自動でフェードアウトして交代します(端末内で合成するため通信不要。「環境音を試聴」で音色と音量を確認できます)
5. 「テスト再生」で音量と声を確認(小さめ推奨)
6. 「おやすみを開始する」をタップ → iPhoneを充電器につなぎ、画面を上にして就寝
